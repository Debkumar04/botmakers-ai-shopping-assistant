            ...
            <div className="flex gap-5">
              {FOOTER_LINKS.socialMedia.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  className="w-8 h-10 rounded-xl border border-[#2d2d36] bg-[#12121a] flex items-center justify-center text-[#8b8b95] text-xl hover:border-[#ef4444] hover:text-[#ef4444] transition-all duration-300"
                >
