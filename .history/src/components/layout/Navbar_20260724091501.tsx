          ...
          <div className="lg:hidden border-t border-[#262630] bg-[#09090F]/95 backdrop-blur-xl shadow-2xl">
            <div className="page-container py-8">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8 pt-6 border-t border-[#262630]">
                <button className="h-9 min-w-[96px] px-6 rounded border border-[#2d2d36] bg-[#0d0d13] text-white text-[14px] font-[Rajdhani] font-bold uppercase tracking-widest transition-all duration-300 hover:border-[#ef4444]">
                  LOGIN
                </button>

                <button className="h-9 min-w-[110px] px-6 rounded bg-[#ef4444] text-white text-[14px] font-[Rajdhani] font-bold uppercase tracking-widest transition-all duration-300 hover:bg-[#dc2626]">
                  REGISTER
                </button>
              </div>
            </div>
