          ...
          <div className="lg:hidden border-t border-[#262630] bg-[#09090F]/95 backdrop-blur-xl shadow-2xl">
            <div className="page-container py-8">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8 pt-6 border-t border-[#262630]">
                <button className="h-10 px-7 rounded-md border border-[#333344] text-white font-[Rajdhani] text-[15px] font-semibold uppercase tracking-[0.08em] transition-all duration-300 hover:border-[#ef4444] hover:-translate-y-0.5">
                  Login
                </button>

                <button className="h-10 px-7 rounded-md bg-[#ef4444] text-white font-[Rajdhani] text-[15px] font-semibold uppercase tracking-[0.08em] transition-all duration-300 hover:bg-[#dc2626] hover:-translate-y-0.5">
                  Register
                </button>
              </div>
            </div>
