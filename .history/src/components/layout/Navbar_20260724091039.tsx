          ...
          <div className="lg:hidden border-t border-[#262630] bg-[#09090F]/95 backdrop-blur-xl shadow-2xl">
            <div className="page-container py-8">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8 pt-6 border-t border-[#262630]">
                ...
                <button className="h-11 rounded-lg border border-[#333344] text-white uppercase font-[Rajdhani] tracking-wider font-semibold transition hover:border-[#ef4444]">
                  Login
                </button>

                <button className="h-11 rounded-lg bg-[#ef4444] text-white uppercase font-[Rajdhani] tracking-wider font-semibold transition hover:bg-[#dc2626]">
                  Register
                </button>
